...
Car* Car_create(Vector2 pos, float acc, int width, int height, Color color, float angle, float angularAcc, float minTurnSpeed, float breakForce, float dragForce, int id);
...
void Car_info(Car* car); // Mostra as informações do carro no console
