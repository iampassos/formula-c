...
void cleanup(); // Função para liberar os recursos após o fim da execução do jogo
...
void setup() {
    ...
    Track_setColor(TRACK_COLOR, LIGHT_ESCAPE_AREA_COLOR, HARD_ESCAPE_AREA_COLOR, OUTSIDE_TRACK_COLOR);
