...
void setup() {
    ...
    Image bgImage =
        LoadImage("resources/masks/pista_debug_mask.png"); // Pista exibida
    ...
    Track_setDrag(TRACK_DRAG, LIGHT_ESCAPE_AREA_DRAG, HARD_ESCAPE_AREA_DRAG,
                  OUTSIDE_TRACK_DRAG);
    ...
    Car *car1 =
        Car_create((Vector2){SCREEN_WIDTH / 2.0f, SCREEN_HEIGHT / 3.0f}, // pos
